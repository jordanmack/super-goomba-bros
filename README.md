...
Lives stay on the WORLD intro. That intro and GAME OVER scale with the
playfield. TIME counts down from the stage timer and kills
...
Fireballs match the shooter's size. Player fireballs
